...
import { ArrowRight, Check, Download, Scale, FileText, PiggyBank, Calculator, Building2, BarChart as ChartBar, ChevronDown } from 'lucide-react';
...
export default function GuideFiscal() {
  ...
  const handleConfirmRedirect = () => {
    openStripePopup('https://buy.stripe.com/00g9DCeHM60CaZy6os');
    ...
    <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            <img
              src="/Optimisation Fiscale (2).png"
              alt="Guide Fiscal"
          ...
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl font-bold text-[#193A6B] mb-4">
                Guide Optimisations Fiscales et Juridiques
              </h1>
              <p className="text-xl text-gray-600 mb-4">
                Maîtrisez la fiscalité française en tant que non-résident
              </p>
              <div className="flex items-center space-x-4 mb-8">
                <span className="text-3xl font-bold text-[#193A6B]">250€</span>
                <span className="text-lg text-gray-500 line-through">1000€</span>
            ...
            <div className="prose text-gray-600">
              <p className="mb-4">
                Économisez des milliers d'euros en évitant les pièges fiscaux courants. Notre guide vous donne accès aux stratégies éprouvées et aux solutions concrètes pour surmonter les obstacles traditionnels du crédit immobilier.
              </p>
            </div>
            ...
            <div className="bg-[#FFFCEF] rounded-xl p-6 space-y-4">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Stratégies pour ne pas payer d'impôt en France",
                  "Solutions pour éviter la double imposition",
                  "Niches fiscales disponibles pour les expatriés",
                  "Comment éviter d'être considéré résident fiscal français",
                  "Choix optimal entre SCI et nom propre",
                  "Étapes détaillées pour l'acquisition d'un bien",
                  "Points de vigilance notariaux essentiels"
                ].map((item, index) => (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-8 max-w-md mx-4">
            ...
            <p className="text-gray-600 mb-6">
              Vous allez être redirigé vers notre page de paiement sécurisée Stripe pour finaliser votre commande du Guide Fiscal.
            </p>
